(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [405], {
        ...
        8876: function(e, t, s) {
            ...
            var f = function() {
                    var e, t = (e = x().mark((function e(t) {
                        var s;
                        return x().wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return e.next = 2, h().get(t);
                                case 2:
                ...
                C = function() {
                    var e = function(e) {
                            if (e) {
                                var t = e.split(" ");
                                return t.length <= 7 ? e : "".concat(t[0], " ").concat(t[1], " ").concat(t[2], " ").concat(t[3], " ...")
                            }
                        },
                        t = (0, c.ZP)("/api/now-playing", f),
                        s = t.data,
                        l = (t.error, e(null === s || void 0 === s ? void 0 : s.title));
                    e(null === s || void 0 === s ? void 0 : s.artist);
                    return (0, r.jsx)(r.Fragment, {
                        children: (0, r.jsxs)("div", {
                            className: "font-sen mb-8 flex flex-col items-center gap-2 text-center text-sm text-gray-300",
                            children: [(0, r.jsx)("p", {
                                className: "text-white",
                                children: "See what I'm currently listening on Spotify"
                            }), (0, r.jsxs)("div", {
                                ...
                                children: [(0, r.jsx)(i(), {
                                    ...
                                    height: "20",
                                    alt: "spotify icon"
                                }), (null === s || void 0 === s ? void 0 : s.isPlaying) ? (0, r.jsx)(a(), {
                                    href: null === s || void 0 === s ? void 0 : s.songUrl,
                                    passHref: !0,
                                    children: (0, r.jsx)("p", {
                                    ...
                                    children: "No listening to anything"
                                })]
                            })]
                        })
                    })
            ...
            function g() {
                return (0, r.jsxs)("div", {
                    children: [(0, r.jsx)("div", {
                        ...
                        children: (0, r.jsxs)("div", {
                            className: "flex min-h-screen flex-col bg-primary",
                            children: [(0, r.jsx)("div", {
                                style: {
                                ...
                                className: "mx-auto -mt-20 flex w-full max-w-2xl flex-1 flex-col items-center px-0 sm:px-10",
                                children: (0, r.jsx)("div", {
                                    className: "relative mb-6 flex w-full flex-col justify-center bg-opacity-90 px-2 sm:min-h-full sm:rounded-lg sm:px-6",
                                    children: (0, r.jsxs)("div", {
                                        className: "flex flex-col items-center justify-center rounded-md p-2 py-4",
                                        children: [(0, r.jsx)("div", {
                                            className: "relative",
                                            children: (0, r.jsx)(i(), {
                                            ...
                                            children: (0, r.jsxs)("div", {
                                                ...
                                                children: [(0, r.jsxs)("div", {
                                                    ...
                                                    children: [(0, r.jsx)("span", {
                                                        className: "flex text-center text-2xl font-bold leading-tight text-zinc-300",
                                                        children: "KOI"
                                                    }), (0, r.jsx)("div", {
                                            ...
                                            children: (0, r.jsxs)("div", {
                                                children: [(0, r.jsxs)("div", {
                                                    ...
                                                    children: [(0, r.jsx)("a", {
                                                        ...
                                                        target: "_self",
                                                        href: "https://twitter.com/neekoi_",
                                                        ...
                                                        rel: "noopener noreferrer nofollow",
                                                        target: "_self",
                                                        href: "https://instagram.com/neekoi_",
                                                        className: "flex cursor-pointer items-center justify-center rounded-full border-white border-opacity-10 bg-opacity-10 p-1.5 transition-all",
                                                        children: (0, r.jsxs)("svg", {
                                                        ...
                                                        rel: "noopener noreferrer nofollow",
                                                        target: "_self",
                                                        href: "https://open.spotify.com/user/31x26y6mbrwjpxkl64skncmykrbu",
                                                        className: "flex cursor-pointer items-center justify-center rounded-full border-white border-opacity-10 bg-opacity-10 p-1.5 transition-all",
                                                        children: (0, r.jsxs)("svg", {
                                                        ...
                                                        rel: "noopener noreferrer nofollow",
                                                        target: "_self",
                                                        href: "https://id.pinterest.com/neekoi_",
                                                        className: "flex cursor-pointer items-center justify-center rounded-full border-white border-opacity-10 bg-opacity-10 p-1.5 transition-all",
                                                        children: (0, r.jsxs)("svg", {
                                                        ...
                                                        children: (0, r.jsxs)("div", {
                                                            ...
                                                            children: [(0, r.jsx)("div", {
                                                                ...
                                                                children: [(0, r.jsxs)("svg", {
                                                                    ...
                                                                    children: (0, r.jsx)("a", {
                                                                        href: "https://discordapp.com/users/937249509694656513",
                                                                        children: j
                                                                    })
                                                                })]
                                                            })]
                                                        ...
                                                        className: "max-w-s mt-1 w-full space-y-2",
                                                        children: (0, r.jsx)("div", {
                                                            ...
                                                            children: (0, r.jsx)("a", {
                                                                ...
                                                                children: (0, r.jsx)("div", {
                                                                    children: (0, r.jsxs)("span", {
                                                                        className: "relative mt-2 flex w-full flex-row items-center justify-between rounded bg-zinc-900 text-sm leading-tight",
                                                                        children: [(0, r.jsxs)("div", {
                                                                            className: "flex items-center justify-center",
                                                                            children: [(0, r.jsx)("div", {
                                                                                className: "flex h-16 w-16 items-center justify-center rounded bg-zinc-800 bg-opacity-50",
                                                                                children: (0, r.jsx)("span", {
                                                                                    className: "",
                                                                                    children: " \ud83d\udd4a\ufe0f "
                                                                                })
                                                                                ...
                                                                                children: (0, r.jsx)("span", {
                                                                                    ...
                                                                                    children: "Free Rest Api"
                                                                                })
                                                                            })]
                                                                        }), (0, r.jsx)("span", {
                                                                            className: "absolute right-2 text-zinc-600 transition-all",
                                                                            children: (0, r.jsx)("svg", {
                                                                                xmlns: "http://www.w3.org/2000/svg",
                                                                                viewBox: "0 0 20 20",
                                                                                fill: "currentColor",
                                                    ...
                                                    children: [(0, r.jsx)("div", {
                                                        className: "flex items-center justify-center rounded-full bg-primary bg-opacity-90 text-xs font-medium text-banner"
                                                    }), (0, r.jsx)("div", {
                                                        className: "max-w-s mt-1 w-full space-y-2",
                                                        children: (0, r.jsx)("div", {
                                                            className: "bg-animate group mb-1 w-full cursor-pointer rounded bg-gradient-to-r from-zinc-900 via-zinc-600 to-zinc-900 text-sm text-zinc-400 shadow transition-all",
                                                                        ...
                                                                        children: [(0, r.jsxs)("div", {
                                                                            ...
                                                                            children: [(0, r.jsx)("div", {
                                                                                ...
                                                                                children: (0, r.jsx)("span", {
                                                                                    title: "\u2661",
                                                                                    className: "text-ellipsis text-[16px] text-zinc-400",
                                                                                    children: "Download Lumine-MD V3.0"
                                                                                })
                                                                            })]
                                                                        }), (0, r.jsx)("span", {
                                                                            className: "absolute right-2 text-zinc-600 transition-all",
                                ...
                                children: (0, r.jsx)("div", {
                                    ...
                                    children: (0, r.jsx)("footer", {
                                        children: (0, r.jsxs)("div", {
                                            ...
                                            children: ["\u30b3\u30a4", (0, r.jsx)("p", {
                                                className: "text-gray text-s",
                                                children: "\xa9 2023 - Somewhen, Somewhere."
                                            })]
                                        })
                                    })
                                })
    ...
    function(e) {
        e.O(0, [675, 708, 774, 888, 179], (function() {
